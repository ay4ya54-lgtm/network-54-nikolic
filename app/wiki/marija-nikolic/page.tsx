    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="flex">
        ...
        <div className="flex-1 py-6 px-6">
          <h1 className="text-4xl font-serif font-medium mb-2 text-red-600">Marija Nikolic</h1>
            ...
            <div className="flex gap-6">
              ...
              <aside className="hidden md:block w-72 flex-shrink-0 order-2">
                <div className="bg-gray-900 border border-gray-700 rounded">
                  ...
                  <div className="bg-red-900/50 px-3 py-2 border-b border-gray-700 text-center">
                    <span className="text-lg font-serif font-semibold text-red-500">MARIJA NIKOLIC</span>
                  </div>
                  ...
                  <div className="divide-y divide-gray-800 text-sm">
                    <div className="px-3 py-2">
                      ...
                      <p className="text-gray-300">Marija Nikolic</p>
                    </div>
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Nascimento</span>
                      <p className="text-gray-300">1950</p>
                      <p className="text-gray-400 text-xs">Neo-Iugoslávia</p>
                    </div>
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Idade em 2045</span>
                      <p className="text-gray-300">95 anos</p>
                    </div>
                    <div className="px-3 py-2">
                    ...
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Irmão</span>
                    ...
                    <div className="px-3 py-2">
                      ...
                      <Link href="/wiki/martin-nikolic" className="text-red-500 hover:underline block">Martin Nikolic</Link>
                    </div>
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Presença digital</span>
                      <p className="text-yellow-500">Baixíssima</p>
                    </div>
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Estilo de vida</span>
                      <p className="text-gray-300">Extremamente reservado</p>
                      <p className="text-gray-300">Isolado de ambientes corporativos</p>
                    </div>
                    <div className="px-3 py-2">
                      <span className="text-gray-500">Condição médica</span>
                      <p className="text-yellow-500">Alzheimer avançado</p>
                    </div>
                    <div className="px-3 py-2">
                    ...
                    <div className="px-3 py-2">
                      ...
                      <p className="text-red-500">Arquivos incompletos</p>
                      <p className="text-gray-400 text-xs">Poucas informações após 2039</p>
                    </div>
                  </div>
                </div>
              </aside>
              ...
              <article className="prose prose-invert max-w-none flex-1 order-1">
                <p className="text-gray-300 leading-relaxed mb-4">
                  <strong className="text-white">Marija Nikolic</strong> (Neo-Iugoslávia, 1950) é uma figura praticamente desconhecida publicamente, conhecida apenas por sua relação familiar como irmã do jornalista investigativo <Link href="/" className="text-red-500 hover:underline">Chidi Aleksandar Nikolic</Link>. Diferente dos demais membros da família Nikolic, Marija manteve vida extremamente reservada e completamente distante de ambientes políticos, corporativos ou midiáticos ao longo de praticamente todas as suas sete décadas.
                </p>
                
                <p className="text-gray-300 leading-relaxed mb-4">
                  Registros públicos sobre sua trajetória são limitados, parcialmente incompletos e concentram-se principalmente em documentação administrativa de era pré-digital. Fontes civis apontam que Marija viveu grande parte de sua vida fora de Night City, em regiões rurais ou comunidades isoladas, retornando à cidade apenas durante os anos finais da carreira profissional de seu irmão.
                </p>

                <h2 className="text-xl font-serif font-semibold text-red-600 mt-6 mb-3 border-b border-gray-700 pb-2">Vida pessoal e isolamento</h2>
                
                <p className="text-gray-300 leading-relaxed mb-4">
                  Pouco é conhecido sobre a vida pessoal de Marija. Fontes familiares indicam que ela possui ao menos um filho, <Link href="/wiki/martin-nikolic" className="text-red-500 hover:underline">Martin Nikolic</Link>, embora informações sobre ele também sejam extremamente limitadas. Não existem registros públicos de carreira profissional, afiliações corporativas ou participação política significativa.
                </p>

                <p className="text-gray-300 leading-relaxed mb-4">
                  A ausência deliberada de presença digital ou participação em sistemas corporativos caracteriza toda sua existência documentada. Diferentemente de seu irmão Chidi, que enfrentou ativamente estruturas de poder através da investigação jornalística, Marija adotou estratégia oposta: completo isolamento e desaparecimento voluntário de espaços públicos.
                </p>

                <h2 className="text-xl font-serif font-semibold text-red-600 mt-6 mb-3 border-b border-gray-700 pb-2">Situação atual</h2>
                
                <p className="text-gray-300 leading-relaxed mb-4">
                  Acredita-se que Marija atualmente resida sob cuidados familiares diretos, devido ao avanço de complicações neurológicas relacionadas ao Alzheimer em estágio muito avançado. Sua presença em bancos públicos de dados corporativos ou governamentais tornou-se praticamente inexistente após 2039.
                </p>

                <p className="text-gray-300 leading-relaxed mb-4">
                  A própria existência de Marija Nikolic permanece como lacuna histórica dentro dos registros públicos de Night City, representando uma forma rara de obscuridade total em era de vigilância ubíqua. Seu apagamento voluntário de sistemas públicos contrasta radicalmente com a hypervisibilidade forçada que caracteriza a maioria das vidas na cidade.
                </p>
              </article>
            </div>
          ) : (
            ...
            <div>
              ...
              <div className="mt-2 space-y-2">
                <div className="w-full h-24 bg-gradient-to-br from-gray-800 to-gray-700 rounded flex items-center justify-center">
                  <span className="text-gray-500 font-bold text-sm">Gerontec</span>
                </div>
                <p className="text-gray-400 text-xs">Soluções de saúde para idosos</p>
              </div>
            </div>
          </div>
        </aside>
